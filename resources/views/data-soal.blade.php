            ...
            <div class="min-h-screen p-4 mt-16">
                <div class="grid grid-cols-1">
                    <div class="w-auto shadow-sm card bg-white-custom">
                        <div class="card-body">
                            <h3 class="mb-4 text-base font-medium lg:text-xl text-black-custom">Data Soal Ujian</h3>
                            ...
                            <div class="mt-4 overflow-x-auto">
                                <table class="table table-zebra">
                                    ...
                                    <tr>
                                        <th>1</th>
                                        <td>
                                            <p class="text-sm text-black-custom">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quas, ex!</p>
                                            <ul>
                                                <li class="text-sm text-black-custom">Jawaban A</li>
                                                <li class="text-sm text-blue-custom">Jawaban B (Dipilih)</li>
                                                <li class="text-sm text-black-custom">Jawaban C</li>
                                                <li class="text-sm text-black-custom">Jawaban D</li>
                                                <li class="text-sm text-black-custom">Jawaban E</li>
                                            </ul>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <th>2</th>
                                        <td>
                                            <p class="text-sm text-black-custom">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Saepe, tempore et? Et perferendis voluptates explicabo.</p>
                                            <ul>
                                                <li class="text-sm text-black-custom">Jawaban A</li>
                                                <li class="text-sm text-black-custom">Jawaban B</li>
                                                <li class="text-sm text-black-custom">Jawaban C</li>
                                                <li class="text-sm text-blue-custom">Jawaban D (Dipilih)</li>
                                                <li class="text-sm text-black-custom">Jawaban E</li>
                                            </ul>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <th>3</th>
                                        <td>
                                            <p class="text-sm text-black-custom">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Earum reiciendis numquam rem dolores omnis eveniet magnam aspernatur harum quis minus.</p>
                                            <ul>
                                                <li class="text-sm text-black-custom">Jawaban A</li>
                                                <li class="text-sm text-black-custom">Jawaban B</li>
                                                <li class="text-sm text-blue-custom">Jawaban C (Dipilih)</li>
                                                <li class="text-sm text-black-custom">Jawaban D</li>
                                                <li class="text-sm text-black-custom">Jawaban E</li>
                                            </ul>
                                        </td>
