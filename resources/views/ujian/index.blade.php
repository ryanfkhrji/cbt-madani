                    ...
                    <div class="mb-5">
                        <a href="{{ route('master_ujian.create') }}">
                            <button type="button" class="bg-black btn text-white-custom"><i
                                    class="fa-solid fa-plus"></i>Tambah Ujian</button>
                        </a>
                    </div>
                            ...
                            <tbody class="text-black-custom dark:text-white-custom">
                                ...
                                @foreach ($ujian as $data)
                                    <tr>
                                        ...
                                        <td class="px-4 py-2">{{ $data->mapel->nama_mapel ?? 'Ujian Telah Di Hapus' }}</td>
                                        ...
                                        <td class="flex gap-2 px-4 py-2">
                                            ...
                                            <form action="{{ route('master_ujian.destroy', $data->id) }}" method="POST"
