...
@section('content-admin')
    <div class="min-h-screen p-4 mt-16">
        <div class="grid grid-cols-1">
            <div class="w-auto shadow-sm card bg-white-custom dark:bg-dark-black-custom">
                <div class="card-body">
                    <h3 class="mb-4 text-base font-medium lg:text-xl text-black-custom dark:text-white-custom">Tambah Jurusan
                    </h3>
                    <form action="{{ route('master_jurusan.store') }}" method="POST">
                        ...
                        <div class="flex flex-wrap gap-1 pt-4">
                            <button type="submit" class="text-white bg-black btn"
                                id="simpan"><i
    ...
    <script>
        ...
        simpan.addEventListener('click', () => {
            Swal.fire({
            title: "Berhasil!",
            text: "Berhasil Menambahkan Jurusan",
            icon: "success",
