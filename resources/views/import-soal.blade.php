            ...
            <div class="min-h-screen p-4 mt-16">
                <div class="grid grid-cols-1">
                    <div class="w-auto shadow-sm card bg-white-custom">
                        <div class="card-body">
                            <h3 class="mb-4 text-base font-medium lg:text-xl text-black-custom">Import Soal Ujian</h3>
                            <form action="/import-soal" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="flex flex-wrap gap-1 pt-4">
                                    ...
                                    <button type="button" onclick="{window.location.href='{{ route('master_soal.index') }}'}" class="btn bg-red-custom text-white-custom" id="batal"><i class="fa-regular fa-circle-xmark text-white-custom"></i>Batal</button>
                                </div>
                            </form>
                        </div>
                    </div>
