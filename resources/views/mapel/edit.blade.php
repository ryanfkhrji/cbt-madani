    ...
    <div class="min-h-screen p-4 mt-16">
        <div class="grid grid-cols-1">
            <div class="w-auto shadow-sm card bg-white-custom dark:bg-dark-black-custom">
                <div class="card-body">
                    <h3 class="mb-4 text-base font-medium lg:text-xl text-black-custom dark:text-white-custom">Edit Mapel
                    </h3>
                    <form action="{{ route('master_mapel.update', $mapel->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="jurusan"
                                class="block mb-3 text-sm font-medium text-black-custom dark:text-white-custom">Guru</label>
                            @if ($errors->has('id_guru'))
                                <div class="mb-2 text-sm text-red-500">{{ $errors->first('id_guru') }}</div>
                            @endif
