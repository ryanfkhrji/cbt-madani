            ...
            <div class="min-h-screen p-4 mt-16">
                <div class="grid grid-cols-1">
                    <div class="w-auto shadow-sm card bg-white-custom">
                        <div class="card-body">
                            <h3 class="mb-4 text-base font-medium lg:text-xl text-black-custom">Edit Soal Ujian</h3>
                            <form action="">
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="jawaban_benar" class="w-full border select border-gray-custom md:w-xs" required>
