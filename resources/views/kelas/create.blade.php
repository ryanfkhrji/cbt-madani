...
<div class="min-h-screen p-4 mt-16">
    <div class="grid grid-cols-1">
        <div class="w-auto shadow-sm card bg-white-custom dark:bg-dark-black-custom">
            <div class="card-body">
                <h3 class="mb-4 text-base font-medium lg:text-xl text-black-custom dark:text-white-custom">Tambah kelas
                </h3>
                <form action="{{ route('master_kelas.store') }}" method="POST">
                    @csrf

                    <div class="mb-4">
                        <label for="kelas" class="block mb-3 text-sm font-medium text-black-custom dark:text-white-custom">
                            Kelas</label>
                        @if ($errors->has('kelas'))
                    ...
                    <div class="flex flex-wrap gap-1 pt-4">
                        ...
                        <button type="button" class="border border-black btn text-black-custom dark:text-white-custom"
