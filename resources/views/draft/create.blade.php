    ...
    <div class="min-h-screen p-4 mt-16">
        ...
        <div class="grid grid-cols-1">
            <div class="w-auto shadow-sm card bg-white-custom dark:bg-dark-black-custom">
                <div class="card-body">
                    <h3 class="mb-4 text-base font-medium lg:text-xl text-black-custom dark:text-white-custom">Tambah Sesi
                        Ujian</h3>
                    <form action="{{ route('master_draft.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex items-center gap-2 mb-2">
                                ...
                                <label for="check-all-siswa" class="text-sm text-black-custom dark:text-white-custom">Pilih
                                    Semua Siswa</label>
                            </div>

                            <select name="id_siswa[]" id="siswa-select"
                                class="w-full select md:w-xs dark:text-white-custom dark:bg-dark-black-custom"
                        ...
                        <div class="flex flex-wrap gap-1 pt-4">
                            ...
                            <button type="button" onclick="{window.location.href='{{ route('master_draft.index') }}'}"
                                class="border-black btn text-black-custom dark:text-white-custom" id="batal"><i
